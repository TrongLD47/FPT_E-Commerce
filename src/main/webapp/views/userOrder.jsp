		...
		<div class="setting">
				...
				<nav class="sidebar" id="sidebar">
					...
					<ul class="nav">
						<li class="nav-item" data-tab-select="user-information"><a
							class="nav-link" href="./user-information.html"> <span
							...
							<ul class="nav-child">
								<li class="nav-child-item" data-tab-select="user-information">
									<a class="nav-child-link" href="./user-information.html"> <span
										class="menu-child-title">Hồ sơ</span>
								</a>
								</li>
								<li class="nav-child-item" data-tab-select="change-password">
									<a class="nav-child-link" href="./change-password.html"> <span
										class="menu-child-title">Đổi mật khẩu</span>
								</a>
								</li>
							</ul></li>
						<li class="nav-item active" data-tab-select="user-order"><a
							class="nav-link" href="./user-order.html"> <span
			...
			<div class="setting__right">
				<div class="user-info" id="user-order">
					<ul class="tab-list">
						<li class="tab-item text-hover active"><a
							href="${pageContext.request.contextPath}/customer/order/list/0">Tất
								cả</a></li>
						<li class="tab-item text-hover"><a
							href="${pageContext.request.contextPath}/customer/order/list/1">Chờ
								xác nhận</a></li>
						<li class="tab-item text-hover"><a
							href="${pageContext.request.contextPath}/customer/order/list/2">Chờ
								lấy hàng</a></li>
						<li class="tab-item text-hover"><a
							href="${pageContext.request.contextPath}/customer/order/list/3">Đang
								giao</a></li>
						<li class="tab-item text-hover"><a
							href="${pageContext.request.contextPath}/customer/order/list/4">Đã
								giao</a></li>
						<li class="tab-item text-hover"><a
							href="${pageContext.request.contextPath}/customer/order/list/5">Đã
								hủy</a></li>
					</ul>
					<c:forEach items="${orders}" var="item" varStatus="loop">
						<div class="order-box-list mt-20">
							...
							<div class="order-box box">
								<c:forEach items="${item.orderDetailEntity}" var="i"
									varStatus="loop">
									<div class="order-box__top">
										...
										<div class="order__state-display">
											<div class="order__product-state">
												<div class="order__product-state__icon">
											...
											<div class="order__state-display__state text-highlight">đang
												giao</div>
										</div>
									</div>
									...
									<div class="order-box__mid">
										...
										<div class="order-box__mid-midle">
											<div class="product__quantity-wrapper button-container">
												<span class="order-product__description">Số lượng: </span> <span
													class="product__quantity qty"> ${i.quantity}</span>
											</div>
										</div>
										...
										<div class="order-box__mid-right">
											...
											<div class="discountPercent">
												<i>-</i>${i.productEntity.discountEntity.percentz}<i>%</i>
											</div>
									...
									<div class="order-box__bot">
										<div class="order-box__total">
											<span class="order-box__icon-right"><i
												...
												class="order-box__total-price text-highlight">${i.totalDiscountPrice}</span>
										</div>
										<div class="order-box__next-actions">
											...
											<div class="order-box__next-actions__button-list">
												<a class="btn btn-badge"> <span>Mua lại</span>
												</a> <a class="btn btn-badge-border">
													<div class="btn-inner">
														<span>Đã Nhận</span>
													</div>
												</a>
