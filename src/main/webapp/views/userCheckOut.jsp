...
.sidebar .nav-item, .sidebar .nav-child-item {
	position: relative;
	cursor: pointer;
	padding-right: 2rem;
...
.sidebar .nav-item .menu-title, .sidebar .nav-child-item .menu-child-title
	{
...
.sidebar .nav-item.active .nav-link .menu-title, .sidebar .nav-item:hover .menu-title,
	.sidebar .nav-child-item.active .menu-child-title, .sidebar .nav-child-item:hover .menu-child-title,
	...
	/*}*/ .sidebar .nav-link, .sidebar .nav-child-link {
	display: flex;
	align-items: center;
	white-space: nowrap;
	padding: 1.1rem;
...
.user-info .form-group input:focus, .user-info .form-group textarea:focus
	{
	border: 1px solid #9b7ca9;
}

.user-info .form-group input::placeholder, .user-info .form-group textarea::placeholder
	{
	color: #595959;
}
...
.navbar-dropdown-title, .navbar-dropdown .dropdown-navigating {
	font-size: 1.6rem;
	padding: 1.5rem 2rem;
}
...
.gender__item-list .gender__item label::after {
	...
	border-radius: 50%;
	background: #fff;
	transition: width 0.15s ease-in-out, height 0.15s ease-in-out, left
		0.15s ease-in-out, top 0.15s ease-in-out;
}
...
[type="checkbox"], [type="radio"], .gender__item label {
	cursor: pointer;
}
...
.order-product__description, .order-product__quantity {
	font-size: 1.4rem;
}
...
.order-box__mid, .order-box__next-actions {
	display: flex;
	justify-content: space-between;
	align-items: center;
}
		...
		<div class="header-bottom">
			...
			<ul class="header-bottom-left">
				...
				<li class="header-bottom-item"><a href="#"> <span
						class="header-bottom-item-text text-hover active">Thanh
							Toán</span>
				</a></li>
			</ul>
			<!-- end Header-left -->
				...
				<div class="user-info" id="user-order">
					<div class="user-infor-address">
						<div class="text-highlight">
							<i class="fa-solid fa-location-dot"></i> <span> Thông tin
								nhận hàng </span>
						</div>
					...
					<ul class="tab-list-cart">
						<li class="tab-item text-hover"><a href="#">Sản Phẩm</a></li>
						<li class="tab-item text-hover"><a href="#">Số Lượng</a></li>
						<li class="tab-item text-hover"><a href="#">Số tiền</a></li>
					</ul>
									...
									<div class="order-box__mid-left">
										<div class="order-box__product">
											<div class="order-product__img">
												<img
													src="${pageContext.request.contextPath}/${item.pathImage}"
								...
								<div class="order-box__next-actions">
									...
									<div class="order-box__next-actions__button-list">
										<a class="btn btn-badge"
											href="${pageContext.request.contextPath}/order"> <span>Mua
												Ngay</span>
										</a>
									</div>
								</div>
