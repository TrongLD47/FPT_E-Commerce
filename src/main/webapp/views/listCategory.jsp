			...
			<aside id="layout-menu"
				...
				<div class="app-brand demo">
					<a href="index.html" class="app-brand-link"> <span
						class="app-brand-logo demo"> <img alt="" src="../imgs/logo.png" style="height: 45px; width: 55px">
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item active"><a href="javascript:void(0);"
						...
						<ul class="menu-sub">
							<li class="menu-item active"><a href="${pageContext.request.contextPath}/admin/listCategory"
								class="menu-link">
						...
						<ul class="menu-sub">
							...
							<li class="menu-item"><a
								href="pages-misc-under-maintenance.html" class="menu-link">
									<div data-i18n="Under Maintenance">Yêu cầu mở Shop</div>
							</a></li>
						</ul></li>
				</ul>
			</aside>
			...
			<div class="layout-page">
				...
				<nav
					...
					<div class="navbar-nav-right d-flex align-items-center"
						...
						<!-- Search -->
						<form:form
							action="${pageContext.request.contextPath}/admin/doSearchCategory"
							method="get">
									...
									<table class="table">
										<thead class="table-light">
											<tr>
												...
												<th><strong>MÃ DANH MỤC</strong></th>
												<th><strong>THAO TÁC</th>
											</tr>
										</thead>
										<tbody class="table-border-bottom-0">
											...
											<c:choose>
												<c:when
													test="${listCategory !=null && listCategory.size() gt 0}">
