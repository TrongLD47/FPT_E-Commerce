...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/components/modal.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/components/pagination.css" />
<title>Shop</title>
</head>
			...
			<div class="header__menu">	
				...
				<ul class="menu">
					<li class="menu__sub active" onclick="activeTab(0)"><a
						href="#" class="menu__link"><span
							class="menu__text text-hover">Tổng quát</span></a></li>
			...
			<div class="brand__left">
				<div class="brand-item__info">
					...
					<div class="brand-item__description">
						...
						<a class="brand-item__popup-link"
							onclick="toggleBranchDetailModal()">Xem thêm</a>
					</div>
				</div>
					...
					<li class="col c-6 m-4 l-2-4 py-1"><a href="#">
							<div class="card">
								...
								<div class="card-text">
									...
									<span class="card-price"> ${item.unitPrice } </span> <span
										class="card-price-discount">
										${item.discountEntity.percentz } </span>
		...
		<section class="page-section mt-1">
			<div class="tittle-product">
				...
				<ul class="top-category row">
					...
					<li class="col c-4 m-3 l-2-4"><a href="#">
							<div class="top-item">
								<span><img src="/assets/img/shop/shop-banner.webp"
									alt="Áo thun" /></span>
								<div class="top-text">
									<p class="top-title text-hover">Áo khoác</p>
									<span class="top-quant">7,337</span><span>sản phẩm</span>
							...
							<div class="tab-bar__filter-list">
								<div class="tab-bar__filter-item">
									<button class="btn filter-item__button">
										<span class="filter-item__text">Bộ lọc</span> <i
											class="fas fa-filter filter-icon"></i>
									</button>
								</div>
								<div class="">
								...
								<div class="tab-bar__filter-item">
									<button class="btn filter-item__button"
										...
										<span class="filter-item__text">Phân loại</span><i
											class="fas fa-caret-down filter-icon"></i>
									</button>
									<div class="dropdown">
										...
										<div class="dropdown__select-list">
											<input class="dropdown__select-item" id="type_all"
												name="type_category" type="radio" value=""> <label
												class="btn" for="type_all"><span>Toàn bộ</span></label> <input
												class="dropdown__select-item" id="type_male"
												name="type_category" type="radio" value="male"><label
												class="btn" for="type_male"><span>Nam</span></label><input
												class="dropdown__select-item" id="type_female"
												name="type_category" type="radio" value="female"><label
												class="btn" for="type_female"><span>Nữ</span></label><input
												class="dropdown__select-item" id="type_accessory"
												name="type_category" type="radio" value="other"><label
												class="btn" for="type_accessory"><span>Phụ
													kiện</span></label>
										</div>
									</div>
								</div>
								<div class="tab-bar__filter-item">
									...
									<div class="dropdown">
										...
										<div class="divider"></div>
										<div class="dropdown__select-list">
											<input class="dropdown__select-item" id="sort_all"
												name="type_sort" type="radio" value=""> <label
												class="btn" for="sort_all"><span>Toàn bộ</span></label> <input
												class="dropdown__select-item" id="sort_trending"
												name="type_sort" type="radio"><label class="btn"
												for="sort_trending"><span>Nổi bật</span></label><input
												class="dropdown__select-item" id="sort_new" name="type_sort"
												type="radio"><label class="btn" for="sort_new"><span>Mới
													về</span> </label><input class="dropdown__select-item"
												id="sort_price_desc" name="type_sort" type="radio"><label
												class="btn" for="sort_price_desc"><span>Giá
													giảm nhiều</span></label><input class="dropdown__select-item"
												id="sort_price_high" name="type_sort" type="radio"><label
												class="btn" for="sort_price_high"><span>Giá
													cao trước</span></label><input class="dropdown__select-item"
												id="sort_price_low" name="type_sort" type="radio"><label
												class="btn" for="sort_price_low"><span>Giá
													thấp trước</span></label>
										</div>
									</div>
								</div>
								<div class="tab-bar__filter-item">
									...
									<div class="dropdown">
										...
										<div class="divider"></div>
										<div class="dropdown__select-list"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div>
						...
						<div>
							...
							<button class="button primary-button"
								style="width: 150px; margin: auto; display: none" disabled="">
		...
		<section class="brand-reviews">
			...
			<div class="brand-reviews__right">
					...
					<div class="tab-bar__filter-list review-filter">
						<div class="tab-bar__filter-item">
							<button class="btn filter-item__button" onclick="filterReview(0)">
								<span class="filter-item__text">Toàn bộ</span>
							</button>
						</div>
						<div class="tab-bar__filter-item">
				...
				<div class="feedback">
					<div class="box">
						<div class="review-item__info">
							<a href="#"> <img width="40" height="40" class="user__avatar"
							...
							<div class="user__rating-wrapper">
								...
								<div class="user__rating-info">
									<span class="user__rating-time">3 tháng</span> <span
										class="user__rating"><i
										class="fas fa-star star-icon active"></i> <i
										class="fas fa-star star-icon active"></i> <i
										class="fas fa-star star-icon active"></i> <i
										class="fas fa-star star-icon"></i> <i
										class="fas fa-star star-icon"></i> </span>
								</div>
								<div class="review-item__preview">
									<div class="review-preview__left">
										<div class="review-preview__product">
											<a href=""><img class="review-preview__product-img"
												...
												width="76" height="76" src="/assets/img/shop/shop-logo.webp"></a>
											<div class="review-preview__product-summary">
												<a class="review-preview__product-brand"><span>URBAN
														OUTFITS</span></a> <span class="review-preview__product-name">Áo
													Thun Tay Lỡ Nữ Nam Form Rộng URBAN OUTFITS In To The Future
													ATO29 Cotton</span>
											</div>
										</div>
										<div class="review-item__feedback">
											<span>Lorem ipsum dolor sit amet consectetur,
												adipisicing elit. Commodi deleniti saepe et numquam itaque
												aut omnis praesentium earum, illo suscipit excepturi modi
												tempora odit quae quo! Alias voluptatum a accusamus. </span>
										</div>
										<!---->
									</div>
								</div>
				...
				<section style="display: none;" class="no-reviews">
					<div>
						<img src="/assets/img/shop/no-review.webp">
